...
A command-line based parking management system developed in C++ that simulates real-world parking operations. Built using core OOP concepts like Encapsulation, Inheritance, Polymorphism, and Abstraction, the system allows users to park vehicles, remove them, and generate bills based on parking duration and vehicle type.
...
This project showcases core C++ concepts such as OOP, file handling, time conversion, conditional logic, loops.
